...
class EstudianteForm(ModelForm):
    ...
    def clean_correo(self):
        ...
        if "@" not in valor or "utpl.edu.ec" not in valor or "gmail.com" not in valor:
            raise forms.ValidationError("Ingrese correo válido para la Universidad o de gmail")
        return valor
...
class NumeroTelefonicoForm(ModelForm):
    ...
    def clean_telefono(self):
        ...
        if len(valor) != 10:
            raise forms.ValidationError("Ingrese un numero de celular con 10 dígitos")
        return valor
